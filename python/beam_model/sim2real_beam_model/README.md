...
, where `weight_data_ordered` stores the collected raw data and `cantilver_data_fix_registration` stores the optimized full-state trajectories by `optimize_trjaectory.py`.
